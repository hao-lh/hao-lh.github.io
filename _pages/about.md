...
* **Proven cross-functional technical leadership:** set architecture and roadmap across Eng/Product/IT/domain SMEs; mentor senior engineers; drive org adoption of new AI capabilities in mission-critical workflows.
* **Hands-on, full-stack implementer:** Python + C/C++; strong systems fundamentals; effective from low-level performance work to platform architecture and operational readiness.
...
* **Production platform stack:** PyTorch, vLLM/SGLang, LlamaIndex, Elasticsearch, Neo4j; Kubernetes/Docker; AWS/GCP/Azure; CI/CD, observability, security/compliance.